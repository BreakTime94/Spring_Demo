...
<div class="container p-0">
    ...
    ${board.content}
        ...
        <div>
            <a href="list?${cri.qs2}" class="btn btn-secondary btn-sm">
            	<i class="fa-solid fa-list-ul"></i> 목록
            </a>
            <a href="modify?bno=${board.bno}&${cri.qs2}" class="btn btn-warning btn-sm ">
        ...
        <div class="d-grid my-2 attach-area">
			...
			<div class="row justify-content-arround w-75 mx-auto attach-thumb">
				...
				<div class="my-2 col-12 col-sm-4 col-lg-2 " data-uuid="${a.uuid}">
					<div class="my-2 bg-primary" style="height: 150px; background-size: cover; background-image:url('${s3url}${a.path}/t_${a.uuid}')">
